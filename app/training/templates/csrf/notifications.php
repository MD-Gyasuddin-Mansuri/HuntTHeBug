        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="panel panel-default" style="margin-top:20px">
                ...
                <div class="panel-body">
                    <p>Notifications are currently set to <?php echo $data[
                        "notifications"
                    ]
                        ? '<strong style="color:#52a74d">ACTIVE</strong>'
                        : '<strong style="color:#F00">DISABLED</strong>'; ?></p>
                    <?php if ($data["notifications"]) { ?>
                        <a href="/notifications?enabled=false" class="btn btn-danger pull-right">Disable Notifications</a>
                    <?php } else { ?>
                        <a href="/notifications?enabled=true" class="btn btn-dark pull-right">Enable Notifications</a>
                    <?php } ?>
                </div>
            </div>
        </div>
