            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <select name="comment_id" class="form-control">
                        ...
                        <?php foreach (
                            scandir(getcwd() . "/../data/blogcomments")
                            as $file
                        ) {
                            if (substr($file, -4, 4) == ".txt") {
                                $id = (int) str_replace(".txt", "", $file); ?>
                            <option value="<?php echo $id; ?>"><?php echo date(
    "d/m/y H:i:s",
    $id
); ?></option>
                        <?php
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post">
                        ...
                        <div style="margin-top:10px"><input type="submit" class="btn btn-dark pull-right" value="Leave Comment"></div>
                    </form>
                </div>
            </div>
