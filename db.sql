...
CREATE USER 'huntthebug'@'%' IDENTIFIED WITH mysql_native_password BY 'literallyhuntthebug';
GRANT SELECT ON `huntthebug`.* TO 'huntthebug'@'%';
FLUSH PRIVILEGES;
